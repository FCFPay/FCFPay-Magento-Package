...
{
    const CODE = 'fcfpay_PaymentGateway';
     ...
     * @param \fcfpay\PaymentGateway\Model\ConfigFactory $configFactory,
    ...
    public function __construct(
        ...
        \fcfpay\PaymentGateway\Model\ConfigFactory $configFactory,
     ...
     * @return \fcfpay\PaymentGateway\Model\ConfigFactory
     */
